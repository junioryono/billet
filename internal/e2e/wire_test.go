...
//
// The same lifecycle the in-process suite proves, with a real HTTP listener and
// a real node loop between the control plane and the compute, and on the docker
// leg a real Docker daemon behind it. Every other test of the protocol
// necessarily supplies one of its two sides; this one supplies neither.
//
