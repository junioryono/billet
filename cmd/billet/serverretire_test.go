...
func TestTheServerRetireFixturesAreTheCommandsOwn(t *testing.T) {
	fixtureSetIs(t, "server-retire", []string{
		...
		"dry-run-continue-retained-archived", "dry-run-continue-retained-done",
		"dry-run-continue-retained-done-unsettled",
		...
		"retired-settled", "retired-pending", "retired-retained-settled", "retired-retained-pending",
