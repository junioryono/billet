...
for token, kind in [
    ...
    ('0.0.0-SNAPSHOT-abcdef1+dirty', 'unreadable'),
    ('v0.0.0-SNAPSHOT-abcdef1+dirty', 'unreadable'),
    ...
    ('v0.0.0-00000229120000-012345abcdef', 'development'),
    ('v0.0.0-20260229120000-012345abcdef', 'unreadable'),
    ('v0.0.0-20260909126000-012345abcdef', 'unreadable'),
...
for raw in [{}, dict(stdout='billet v0.10.1'), dict(rc=0, stdout='billet\n v0.10.1'),
            dict(rc=0, stdout='billet\u001c0.10.1'),
            dict(rc=0, stdout='billet 0.10.1\u001clinux/amd64'),
...
for separator in ['\t', '\v', '\f', '\r', '\u0085', '\u00a0', '\u1680', '\u2000', '\u2028', '\u202f', '\u205f', '\u3000']:
    raw = dict(rc=0, stdout=separator + 'billet' + separator + '0.10.1' + separator + 'linux/amd64')
    if module.executable_version(raw) != {'type': 'release', 'value': 'v0.10.1'}:
        sys.exit('a Go Fields separator was refused: %r' % separator)
