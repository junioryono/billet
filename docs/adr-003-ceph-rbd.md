...
The cache-index lock has a ten-minute stale age chosen for its metadata-scale critical sections rather than inheriting the golden-image publisher's six hours. Age never authorises a break by itself: after the bound a contender still observes the holder's heartbeat for ninety seconds, and any movement preserves a live holder even during a longer eviction pass. A crashed, silent holder is therefore reclaimable by the first retry after ten minutes plus that observation window without manual intervention. The destructive #25 acceptance must cut power while this lock is held, keep retrying through the bound, prove the prior or complete new pointer remains valid, and observe cache service resume after automatic reclamation.
