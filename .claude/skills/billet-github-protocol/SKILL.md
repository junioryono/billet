...
- An abandoned session: still refused at 60 seconds on four runs, successor open at 91 on three and 92 on the fourth (2026-09-04, 30-second polls, so the expiry is bracketed rather than named).
